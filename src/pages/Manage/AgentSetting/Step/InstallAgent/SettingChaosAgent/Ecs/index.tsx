  ...
  const handleFormat = (data: IQueryPluginStatusResult[]) => {
    ...
    data.forEach(item => {
      ...
      if (item.pluginType === 'CHAOS_AGENT') {
        publicIpShow = i18n.t('Public').toString();
      } else {
        publicIpShow = i18n.t('HostMachine').toString();
      }
      ...
      if (item.publicIp && item.privateIp) {
        ip = (
          <span>
            ...
            <br />
            {item.privateIp + i18n.t('Private').toString()}
          </span>
        );
      ...
      switch (item.pluginStatus) {
        case 0:
          pluginStatusShow = i18n.t('To be installed').toString();
          break;
        case 1:
          pluginStatusShow = i18n.t('Installing').toString();
          break;
        case -1:
          pluginStatusShow = i18n.t('Installation failed').toString();
          break;
        case 2:
          pluginStatusShow = i18n.t('Online').toString();
          break;
        case 3:
          pluginStatusShow = i18n.t('Offline').toString();
          break;
        case 4:
          pluginStatusShow = i18n.t('Uninstalling').toString();
          break;
        case 5:
          pluginStatusShow = i18n.t('Uninstall failed').toString();
          break;
        default:
          break;
      }
