  ...
  return (
    <div>
      ...
      {fields.length > 0 && <RadioGroup disabled={disabled} value={and ? 'and' : 'or'} onChange={handleAndChange as any}>
        <Radio id="and" value="and"><Translation>And</Translation></Radio>
        <Radio id="or" value="or"> <Translation>Or</Translation></Radio>
      </RadioGroup>}
      <div className={styles.recoverRules}><Translation>Recovery strategy</Translation></div>
      <div>
        {renderTolerance()}
      </div>
    </div>
