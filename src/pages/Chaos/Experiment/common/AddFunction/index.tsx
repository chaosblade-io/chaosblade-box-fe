  ...
  return (
    <Dialog
      ...
      footer={<div className={styles.btnRow}>
        <Button className={styles.btn} type="primary" disabled={functions.length === 0} onClick={handleSelect} data-autolog={'text=确认选择小程序'}>确定</Button>
        <Button className={styles.btn} type="normal" onClick={handleClose} data-autolog={'取消选择小程序'}>取消</Button>
      </div>}
        ...
        <div className={styles.contentBox}>
          ...
          <div className={styles.listBox}>
            <ul className={styles.functionList}>
              {
                _.isEmpty(functions) ? <div>当前分类暂无场景</div> : functions.map(({ name, functionId }) => {
