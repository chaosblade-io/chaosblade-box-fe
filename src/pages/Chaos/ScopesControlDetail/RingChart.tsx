...
function RingChart() {
  ...
  let info = '';
  if (language === 'zh') {
    info = '<div style=&quot;color:#333;font-size:12px;text-align: center;&quot;>近三月<br><span style=&quot;color:#333;font-size:12px&quot;>演练情况</span></div>';
  } else {
    info = '<div style=&quot;color:#333;font-size:12px;text-align: center;&quot;>Nearly March<br><span style=&quot;color:#333;font-size:12px&quot;>Drill situation</span></div>';
  }
