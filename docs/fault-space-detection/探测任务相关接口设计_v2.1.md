### 1、获取任务列表
http://1.94.151.57:7001/chaos/detection-tasks?page=1&size=10
...
### 2、获取任务详情
http://1.94.151.57:7001/chaos/detection-tasks/3
...
### 3、获取任务执行记录
http://1.94.151.57:7001/chaos/detection-tasks/3/executions
